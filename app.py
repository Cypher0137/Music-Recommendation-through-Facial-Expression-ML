...
st.markdown("<h2 style='text-align: center; color: white;'><b>SENSEbot</b></h2>", unsafe_allow_html=True)
st.write("---------------------------------------------------------------------------------------------------------------------")
model = Sequential()
...
st.markdown("<h2 style='text-align: center; color: white;'><b>Sensing and Recommending</b></h2>", unsafe_allow_html=True)
